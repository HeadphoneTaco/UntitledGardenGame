...
namespace RevManager {
    ...
    ///   MenuScreensController.cs         - screen flow, escape handling, game end
    ///   MenuScreensController.Options.cs - volume sliders, font choice, debug end strip
    /// </summary>
    [RequireComponent(typeof(UIDocument))]
    public partial class MenuScreensController : MonoBehaviour {
